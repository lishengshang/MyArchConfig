...
set bat bat
# Binary used for dynamic completions (list-languages, list-themes)
set -g __bat_cmd bat
if not type -q bat; and type -q batcat
    set -g __bat_cmd batcat
end
...
function __bat_complete_one_language -a comp
    command $__bat_cmd --list-languages | string split -f1 : | string match -e "$comp"
end

function __bat_complete_list_languages
    for spec in (command $__bat_cmd --list-languages)
...
# ── Completions: first-argument-only options ─────────────────────
...
# ── Completions: general options (no exclusive args) ──────────────
...
complete -c $bat -l theme -x -a "$special_themes(__bat_complete_themes)" -d "Set the syntax highlighting theme" -n __bat_no_excl_args
complete -c $bat -l theme-dark -x -a "(__bat_complete_themes)" -d "Set the syntax highlighting theme for dark backgrounds" -n __bat_no_excl_args
complete -c $bat -l theme-light -x -a "(__bat_complete_themes)" -d "Set the syntax highlighting theme for light backgrounds" -n __bat_no_excl_args
...
# ── Completions: options with special conditions ─────────────────
